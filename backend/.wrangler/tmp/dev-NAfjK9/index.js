...
// .wrangler/tmp/bundle-y4ZC9y/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\LENOVO\\Desktop\\pr\\medium\\backend\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
      ...
      "inlineSchemaHash": "c8ce132dfdd2dd317e20741185acb701c9c062d0e109788f8ac487bb181c9ed0",
      "copyEngine": false
    };
    config.dirname = "/";
...
// node_modules/@ajayvish/medium-common/dist/index.js
var require_dist = __commonJS({
  "node_modules/@ajayvish/medium-common/dist/index.js"(exports) {
    "use strict";
    init_checked_fetch();
    init_modules_watch_stub();
    var __importDefault = exports && exports.__importDefault || function(mod) {
...
// .wrangler/tmp/bundle-y4ZC9y/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-y4ZC9y/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
userRouter.post("/signup", async (c) => {
  ...
  try {
    ...
    const jwt = await sign2({ id: user.id }, c.env.SECRET_KEY);
    return c.json({ jwt });
  } catch (e) {
    c.status(403);
...
blogRouter.use("/*", async (c, next) => {
  ...
  try {
    const verified = await verify2(jwt, c.env.SECRET_KEY);
    if (verified) {
