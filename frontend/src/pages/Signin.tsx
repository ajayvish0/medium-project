import { SigninInput } from "@ajayvish/medium-common";
      ...
      <div className="h-screen flex justify-center px-[2rem] items-center">
        <div className="text-center w-96">
          ...
          <p className="text-slate-400 pt-2 ">
            ...
            <Link
              to="/signup"
              className="font-medium text-gr cursor-pointer hover:text-green-800"
            >
              Create one
            </Link>
          </p>
          ...
          {loading && <Spinner />}
          <Button label="Sign in" isLoading={loading} onClick={sendRequest} />
        </div>
      </div>
